  ...
  return (
    <>
      ...
      <main className="bg-gradient-to-r dark:from-black to-black inline-block w-full">
        <section className='py-3 flex justify-center bg-black border-b border-gray-300 text-sm  border-opacity-20 text-red-600 top-0 sticky z-50'> Profile still in development !!</section>
        <section className="dark:bg-white bg-black my-8">
          <div className="container flex justify-between">
            <a href="" className="dark:bg-black bg-white block max-w-max">
        ...
        <section className="relative overflow-hidden flex min-h-md items-center">
          <div className="container relative z-10 py-8 ">
            ...
            <h1 className="text-4xl tracking-tight font-bold text-gray-500  space-y-2 mb-12 z-0 sm:max-w-sm" >
              ...
              <span className="block text-yellow-100 sm:text-5xl md:text-6xl py-2 border-r-2 border-gray-300 text-sm  border-opacity-20">I{"\'"}m Soufiyan</span>
            </h1>
