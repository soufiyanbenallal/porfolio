...
export default function ServicesSection() {
  return (
    <Box type='fade' duration={.5} className="h-screen container overflow-hidden flex items-center">
      {/* <Box /> */}
      <div className="grid grid-cols-1 gap-12  md:grid-cols-2 lg:grid-cols-3 rounded-b-xl ">
        <Box type='slideVertical' y={300} duration={.8} className="col-span-1 md:col-span-2 lg:col-span-3 uppercase">
            <h2 className='text-red-base text-5xl'>The way</h2>
            <p className='dark:text-gray-200 text-[8rem] font-extrabold leading-[1]'>how i work</p>
        </Box>
